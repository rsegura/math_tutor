...
class ProvisioningRepository(Protocol):
    ...
    def create_provisioned_session(self, session: LearningSession, *, profile_version: int, join_code_hash: str, join_expires_at: datetime, consent: "AudioConsent | None") -> str | None: ...
